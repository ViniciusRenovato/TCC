...
public class funcionario_agendamento_cadastrado extends AppCompatActivity {
...
//        lista= findViewById(R.id.lista_emprego_oferecido);
        ...
        //recycle view
        recyclerView=findViewById(R.id.lista_funcionario_cadastrado_agendamento);
...
//        });
    ...
    funcionarioagendamentoAdapter FuncionarioagendamentoAdapter;
    private void preenche_funcionario() {
        FuncionarioagendamentoAdapter= new funcionarioagendamentoAdapter(Funcionario);
        recyclerView.setAdapter(FuncionarioagendamentoAdapter);
