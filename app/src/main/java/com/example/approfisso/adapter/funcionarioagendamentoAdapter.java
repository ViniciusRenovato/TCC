...
import com.example.approfisso.cadastrado.agendamento_cadastrado_estabelecimento;
...
public class funcionarioagendamentoAdapter extends RecyclerView.Adapter<funcionarioagendamentoAdapter.FuncionarioHolder> {
    ...
    public funcionarioagendamentoAdapter(List<Funcionario> funcionario) {
    ...
    public FuncionarioHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        View view =layoutInflater.inflate(R.layout.linhas_funcionario_agendamento,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull FuncionarioHolder funcionarioViewHolder, int i ) {
        ...
        funcionarioViewHolder.funcionarioagenda.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent it = new Intent(view.getContext(), agendamento_cadastrado_estabelecimento.class);
...
//        });
    ...
    public class FuncionarioHolder extends RecyclerView.ViewHolder {
        ...
        private Button funcionarioagenda;
...
//            funcionarioemail=itemView.findViewById(R.id.item_funcionario_email);
            ...
            funcionarioagenda =(Button)itemView.findViewById(R.id.button_agenda_funcionario);
